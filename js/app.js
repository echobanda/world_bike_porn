...
//  var index = 0;
//
//  liSlider[index].style.display = "initial";
//
//  prevButton.on("click", function(event) {
//    var imgUrl = $(event.target).attr('src')
//      imgUrl[index].style.display = "none";
//      index--;
//      if (index < 0) {
//          index = imgUrl.length - 1;
//      }
//      imgUrl[index].style.display = "initial";
//  });
//
//  nextButton.on("click", function() {
//      liSlider[index].style.display = "none";
//      index++;
//      if (index >= liSlider.length) {
//          index = 0;
//      }
//      liSlider[index].style.display = "initial";
//  });
